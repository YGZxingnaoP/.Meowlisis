# -*- coding: utf-8 -*-
# func/toolbox/napcat/emote_controller.py
# NapCat 在线情绪控制：通过 LLM function calling 控制角色在线表情与性格
...
class TBEmoteController:
    """解析 LLM 的 tool_calls，将在线情绪与性格指令传递到 napcat 并落盘（online）"""
    ...
    def __init__(self):
        ...
        self.emotion_bridge = TBNapCatEmotionBridge()
    ...
    def finalize(self) -> List[Dict]:
        """解析完整 tool_calls、落盘在线情绪与性格，必要时触发价值观思考并返回 payload"""
    ...
    def _save_latest(self, result: Dict):
        """保存在线情绪与性格到 .temp/latest_emotion_online.json"""
        try:
