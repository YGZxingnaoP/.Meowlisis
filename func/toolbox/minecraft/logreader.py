# func/toolbox/minecraft/logreader.py
import os
import re
import threading
import time
...
from func.toolbox.minecraft.config import MinecraftConfig
...
class MinecraftLogReader:
    ...
    def load_config(self):
        mc_cfg = self.config
        self.enabled = mc_cfg.enabled
        self.log_path = mc_cfg.log_path
        self.encoding = mc_cfg.encoding
        self.check_interval = mc_cfg.check_interval
        self.use_player_name = mc_cfg.use_player_name
        self.username_fixed = mc_cfg.username_fixed
        self.include_player_name_in_prompt = mc_cfg.include_player_name_in_prompt
        self.filter_players = mc_cfg.filter_players
        self.ignore_self_messages = mc_cfg.ignore_self_messages
