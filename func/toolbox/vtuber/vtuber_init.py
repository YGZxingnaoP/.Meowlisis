...
class VtuberInit:
    ...
    vtuberConfig = VtuberConfig()  # vtuber配置

    def __init__(self):
        self.ws = None
        self._connected = threading.Event()
        if self.vtuberConfig.switch == True:
            self.ws = websocket.WebSocketApp(
                f"ws://{self.vtuberConfig.vtuber_websocket}",
    ...
    def auth(self):
        ...
        authstr = {
            ...
            "data": {
                "pluginName": self.vtuberConfig.vtuber_pluginName,
                "pluginDeveloper": self.vtuberConfig.vtuber_pluginDeveloper,
                "authenticationToken": self.vtuberConfig.vtuber_authenticationToken,
            },
        }
        try:
    ...
    def send(self, data):
        ...
        if self.vtuberConfig.switch == False or self.ws is None:
            return False
